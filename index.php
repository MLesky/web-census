...
switch ($method) {
    ...
    case "POST":
        ...
        $sql = "INSERT INTO users (first_name, second_name, sur_name, gender, date_of_birth, place_of_birth, boys_blw_22, girls_blw_22, boys_abv_21, girls_abv_21, sub_division, town_village) VALUES(:first_name, :second_name, :sur_name, :gender, :date_of_birth, :place_of_birth, :boys_blw_22, :girls_blw_22, :boys_abv_21, :girls_abv_21, :sub_division, :town_village)";
        $stmt = $conn->prepare($sql);
